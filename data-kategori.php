...
<!-- content-->
		<div class="section">
			<div class="container">
				<h3 class="judul1">Data Kategori</h3>
				<div class="box">
					<p>
					...
					<table border="1" cellspacing="0" class="table">
						...
						<tbody>
							<?php 
								$no = 1;
								$kategori = mysqli_query($conn, "SELECT * FROM db_category ORDER BY category_id");
							...
							<tr>
								...
								<td>
									<a href="edit-kategori.php?id=<?php echo $row ['category_id']?>">Edit</a> || <a href="hapus.php?idk=<?php echo $row ['category_id']?>" onclick="return confirm('1 kategori akan dihapus')">Hapus</a>
								</td>
							</tr>
							<?php }}else {?>
							<tr>
